																...
																<div class="row">
																	...
																	<div class="col-sm-6">
																		...
																		<div style="margin-top: 5px;white-space: normal;text-align: left;">
																			<input id="color-fiolet" name="color" type="radio" value="fiolet" style="border: 1px solid #e3e3e3;border-radius: 2px;background-color: #959eac;display: none;margin: 0;">
