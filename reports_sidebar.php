		...
		<div class="sidebar-category sidebar-category-visible">
			<div class="category-content no-padding">
				<ul class="navigation navigation-main navigation-accordion">
					...
					<!-- Main -->
					<li><a href="reports.php"><span>Overview</span></a></li>
					<li><a href="schedule_actual_hours.php"><span>Scheduled vs Actual Hours</span></a></li>
					<li><a href="schedule_actual_clockin.php"><span>Scheduled vs Actual Clock-Ins</span></a></li>
