						...
						<div class="panel panel-flat">
							<div class="panel-heading" style="border-bottom: 1px solid rgb(237, 237, 237);">
								<div class="row">
									<div class="col-md-6 text-left">
										<h4 class="panel-title text-semibold">Setting - Holiday Pay</h4>
									</div>
							...
							<div class="form-group" style="margin-left:15px;">
								<div class="checkbox">
									<label>
										...
										<span style="font-size:16px;">Enable Holiday Pay</span></br><span style="font-size:10px;">Employee timesheets and wages generated on holidays will be billed at the holiday rate set below.</span>
									</label>
								</div>
							</div>
							...
							<div class="form-group" style="margin-left:15px;">
								<div class="checkbox">
									<label>
										<input type="checkbox" class="styled">
										<span style="font-size:16px;">Holiday Pay Rate<input type="text" name="" value=""  class="form-control">x the regular hourly rate</span>
									</label>
								</div>
							</div>
									...
									<div class="input-group">
										...
										<input type="text" class="form-control daterange-single" value="03/18/2013">
											...
											<td>
												...
												<td>
												<button type="button" class="btn btn-primary" style="margin-top:-12px;">Save Changes</button>
											</td>
